...
describe('safebrowsing', () => {
    it('Inits cache', async () => {
        browser.storage.local.get.returns({ [SB_LRU_CACHE_KEY]: JSON.stringify([
            {
        ...
        expect(sbCache.get("CBD6FBF8EB019EBF5865D2A9120D27AC9FC44323A07AED8879E6CD9D28276669")).toBe("adguard-malware-shavar");
    });
